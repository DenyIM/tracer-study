...
<head>
    ...
    <style>
        ...
        .login-logo {
            display: block;              /* supaya bisa di-center pakai margin auto */
            width: 200px;
            height: auto;
            margin: 2rem auto 1rem auto; /* posisi di tengah atas halaman */
            background: #ffffff;         /* latar belakang putih */
            padding: 10px;               /* jarak dalam agar logo tidak mepet */
