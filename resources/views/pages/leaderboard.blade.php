...
<head>
    ...
    <title>Leaderboard - Tracer Study UAD</title>
    @vite(['resources/css/app.css', 'resources/css/leaderboard.css', 'resources/js/app.js', 'resources/js/leaderboard.js']) 
    ...
    <section class="leaderboard-header">
        <div class="container">
            ...
            <div class="points-badge d-inline-block px-4 py-2" data-aos="fade-up" data-aos-delay="200">
                <i class="fas fa-star me-2"></i>Total Points Anda: <strong>15,500</strong>
            </div>
        </div>
    </section>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="benefit-item">
                                    ...
                                    <p class="text-muted">Dapatkan sertifikat penghargaan dari rektor UAD</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="benefit-item">
                        ...
                        <div class="tab-pane fade show active" id="forum" role="tabpanel">
                            <div class="form-section" data-aos="fade-up">
                                ...
                                <form id="forumForm">
                                    ...
                                    <!-- MODIFIKASI: Tombol dengan pulse animation -->
